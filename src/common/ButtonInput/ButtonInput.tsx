...
export const ButtonInput: React.FC<ButtonInputProps> = ({
  ...
  const inputClasses = () =>
    valueIsInvalid
      ? classnames(styles.labelInput, inputClassName, styles.errorBorder)
      : classnames(styles.labelInput, inputClassName);
  ...
  return (
    <label className={styles.label}>
      ...
      {valueIsInvalid && (
        <p className={styles.error}>{labelName} is required.</p>
      )}
    </label>
  );
};
