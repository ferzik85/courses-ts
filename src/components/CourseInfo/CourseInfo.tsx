...
function CourseInfo() {
  ...
  const foundCourse = useSelector((state) =>
    getCourseWithAuthorName(state, params.courseId)
  );
  ...
  return (
    <div className={styles.courseInfo}>
      {courseIsFound ? (
        courseElement(foundCourse)
      ) : (
        <div className={styles.courseIsNotFound}>Course is not found</div>
      )}
      <div>
        <Link to="/courses">
